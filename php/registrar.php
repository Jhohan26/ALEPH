...
$guardar_usuario=$guardar_usuario->prepare("INSERT INTO Usuarios VALUES(NULL, :primer_nombre,:segundo_nombre,:primer_apellido,:segundo_apellido,:usuario,:correo,:contrasena,'',FALSE)");
